<?php
    class Traffic{
        ...
        private function computeTrafficStatus($location,$conditionTable) {
            ...
            ## Modify Code Here
            foreach($conditionTable as $location_keyword => $condition){
                ## Add code here 
                ## (Hint: Consider using EITHER strpos or explode built-in function)

                if (count(explode($location_keyword, $location))>1) {
                    $loc_exists = True;
