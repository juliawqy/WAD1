...
require_once 'ConnectionManager.php'; #import the connection thingy
...
class CatDAO {
    ...
    public function getCats() {
        ...
        $connMgr = new ConnectionManager(); #creating object from connectionmanager
        $conn = $connMgr->connect(); #using the object to connect, then can do SELECT, INSERT, UPDATE, DELETE
        

        // STEP 2
        // Prepare SQL statement
        $sql = "SELECT name, age, gender, status FROM cat"; #select from sql
        ...
        while ($row = $stmt->fetch() ) {
            ...
            $cats[] = $cat; #insert into return arr
        }
